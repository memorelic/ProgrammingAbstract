...
/*
 * Function: RaiseMyException
 * Usage: RaiseMyException(&e, name, value);
 * ---------------------------------------
...
void RaiseMyException(exception *e, string name, void *value);
...
#define raise(e) RaiseMyException(&e, #e, NULL)
